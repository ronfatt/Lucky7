...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-64 border-r border-gold-500/15 bg-obsidian-950/80 backdrop-blur-xl flex-col justify-between shrink-0 h-screen sticky top-0">
      <div>
